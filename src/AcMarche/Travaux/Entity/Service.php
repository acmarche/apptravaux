...
/**
 * @ORM\Entity(repositoryClass="AcMarche\Travaux\Repository\ServiceRepository")
...
class Service
{
    ...
    /**
     * @Gedmo\Slug(fields={"intitule"}, updatable=true)
    ...
    /**
     * @ORM\OneToMany(targetEntity="AcMarche\Travaux\Entity\Intervention", mappedBy="service")
     *
     */
